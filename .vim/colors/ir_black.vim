...
" Generated by http://bytefluent.com/vivify 2012-12-23
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi LineNr guifg=#3D3D3D guibg=#000000 guisp=#000000 gui=bold ctermfg=237 ctermbg=NONE cterm=bold
...
hi Visual guifg=#ffffff guibg=#061b47 guisp=#061b47 gui=bold ctermfg=15 ctermbg=17 cterm=bold
...
hi MatchParen guifg=#f6f3e8 guibg=#3d3833 guisp=#3d3833 gui=NONE ctermfg=230 ctermbg=237 cterm=NONE
